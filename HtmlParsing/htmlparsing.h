...
void htmlHandle::htmlCreator(std::string allFiles, std::vector<std::string> depFiles, std::unordered_map<std::string,std::vector<CodeAnalysis::lineNum>> collapseDB, std::ofstream& js) {
